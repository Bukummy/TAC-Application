 ...
 * and then starts the IntentService {@code TACAppSchedulingService} to do some work.
 */
public class TACAppAlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {   
         ...
         */
        Intent service = new Intent(context, TACAppSchedulingService.class);
    ...
    public void setAlarm(Context context) {
        ...
        Intent intent = new Intent(context, TACAppAlarmReceiver.class);
    ...
    public void cancelAlarm(Context context) {
        ...
        // Disable {@code TACAppBootReceiver} so that it doesn't automatically restart the
